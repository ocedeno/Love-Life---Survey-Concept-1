...
class TouchViewController: UIViewController
{
    ...
    @IBAction func buttonSelected()
    {
        ...
        guard TouchViewController.placementArray.contains("5") else
        {
        ...
        case UIImage(named: "landscape1")!:
            ...
            TouchViewController.placementArray.removeAll()
        ...
        case UIImage(named: "shape1")!:
            ...
            if TouchViewController.userOneIsActive
            {
                self.actionButton.setTitle("User 2 Select", for: .normal)
                TouchViewController.userOneIsActive = false
            }
            else
            {
                let x = getPoints()
                ...
                MainViewController.touchScore = x
                TouchViewController.userOneIsActive = true
            }
    ...
    @IBAction func makeSelection(sender: UIButton)
    {
        ...
        else
        {
            ...
            if image == landscape1 || image == paint1 || image == color1 || image == shape1
            {
                TouchViewController.userTwoResponses.append("A")
            }
            else if image == landscape2 || image == paint2 || image == color2 || image == shape2
            {
                TouchViewController.userTwoResponses.append("B")
            }
            else if image == landscape3 || image == paint3 || image == color3 || image == shape3
            {
                TouchViewController.userTwoResponses.append("C")
            }
            else if image == landscape4 || image == paint4 || image == color4 || image == shape4
            {
                TouchViewController.userTwoResponses.append("D")
            }
            else if image == landscape5 || image == paint5 || image == color5 || image == shape5
            {
                TouchViewController.userTwoResponses.append("E")
            }
        }
        
        if TouchViewController.placementArray.count == 0
        {
            DispatchQueue.main.async {
                sender.setTitle("1", for: .normal)
                TouchViewController.placementArray.append("1")
            }
        }
        else if TouchViewController.placementArray.contains("1")
        {
            if TouchViewController.placementArray.contains("2")
            {
                if TouchViewController.placementArray.contains("3")
                {
                    if TouchViewController.placementArray.contains("4")
                    {
                        if TouchViewController.placementArray.contains("5")
                        {
                        ...
                        else
                        {
                            ...
                            TouchViewController.placementArray.append("5")
                        }
                    }
                    else
                    {
                        ...
                        TouchViewController.placementArray.append("4")
                    }
                }
                else
                {
                    ...
                    TouchViewController.placementArray.append("3")
                }
            }
            else
            {
                ...
                TouchViewController.placementArray.append("2")
            }
    ...
    func getPoints() -> Int
    {
        ...
        let user1GroupA = TouchViewController.userOneRespones[0...4]
        let user1GroupB = TouchViewController.userOneRespones[5...9]
        let user1GroupC = TouchViewController.userOneRespones[10...14]
        let user1GroupD = TouchViewController.userOneRespones[15...19]
        
        let user2GroupA = TouchViewController.userTwoResponses[0...4]
        let user2GroupB = TouchViewController.userTwoResponses[5...9]
        let user2GroupC = TouchViewController.userTwoResponses[10...14]
        let user2GroupD = TouchViewController.userTwoResponses[15...19]
