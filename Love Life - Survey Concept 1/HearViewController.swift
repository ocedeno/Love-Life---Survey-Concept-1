...
class HearViewController: UIViewController
{
    ...
    @IBAction func buttonSelected()
    {
        ...
        guard HearViewController.placementArray.contains("5") else
        {
        ...
        case UIImage(named: "landscape1")!:
            ...
            HearViewController.placementArray.removeAll()
        ...
        case UIImage(named: "shape1")!:
            ...
            if HearViewController.userOneIsActive
            {
                self.actionButton.setTitle("User 2 Select", for: .normal)
                HearViewController.userOneIsActive = false
            }
            else
            {
                let x = getPoints()
                ...
                MainViewController.soundScore = x
                HearViewController.userOneIsActive = true
            }
    ...
    @IBAction func makeSelection(sender: UIButton)
    {
        ...
        else
        {
            ...
            if image == landscape1 || image == paint1 || image == color1 || image == shape1
            {
                HearViewController.userTwoResponses.append("A")
            }
            else if image == landscape2 || image == paint2 || image == color2 || image == shape2
            {
                HearViewController.userTwoResponses.append("B")
            }
            else if image == landscape3 || image == paint3 || image == color3 || image == shape3
            {
                HearViewController.userTwoResponses.append("C")
            }
            else if image == landscape4 || image == paint4 || image == color4 || image == shape4
            {
                HearViewController.userTwoResponses.append("D")
            }
            else if image == landscape5 || image == paint5 || image == color5 || image == shape5
            {
                HearViewController.userTwoResponses.append("E")
            }
        }
        
        if HearViewController.placementArray.count == 0
        {
            DispatchQueue.main.async {
                sender.setTitle("1", for: .normal)
                HearViewController.placementArray.append("1")
            }
        }
        else if HearViewController.placementArray.contains("1")
        {
            if HearViewController.placementArray.contains("2")
            {
                if HearViewController.placementArray.contains("3")
                {
                    if HearViewController.placementArray.contains("4")
                    {
                        if HearViewController.placementArray.contains("5")
                        {
                        ...
                        else
                        {
                            ...
                            HearViewController.placementArray.append("5")
                        }
                    }
                    else
                    {
                        ...
                        HearViewController.placementArray.append("4")
                    }
                }
                else
                {
                    ...
                    HearViewController.placementArray.append("3")
                }
            }
            else
            {
                ...
                HearViewController.placementArray.append("2")
            }
    ...
    func getPoints() -> Int
    {
        ...
        let user1GroupA = HearViewController.userOneRespones[0...4]
        let user1GroupB = HearViewController.userOneRespones[5...9]
        let user1GroupC = HearViewController.userOneRespones[10...14]
        let user1GroupD = HearViewController.userOneRespones[15...19]
        
        let user2GroupA = HearViewController.userTwoResponses[0...4]
        let user2GroupB = HearViewController.userTwoResponses[5...9]
        let user2GroupC = HearViewController.userTwoResponses[10...14]
        let user2GroupD = HearViewController.userTwoResponses[15...19]
