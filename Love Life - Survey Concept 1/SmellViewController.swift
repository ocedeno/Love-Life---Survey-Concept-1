...
class SmellViewController: UIViewController
{
    ...
    @IBAction func buttonSelected()
    {
        ...
        guard SmellViewController.placementArray.contains("5") else
        {
        ...
        case UIImage(named: "landscape1")!:
            ...
            SmellViewController.placementArray.removeAll()
        ...
        case UIImage(named: "shape1")!:
            ...
            if SmellViewController.userOneIsActive
            {
                self.actionButton.setTitle("User 2 Select", for: .normal)
                SmellViewController.userOneIsActive = false
            }
            else
            {
                let x = getPoints()
                ...
                MainViewController.smellScore = x
                SmellViewController.userOneIsActive = true
            }
    ...
    @IBAction func makeSelection(sender: UIButton)
    {
        ...
        else
        {
            ...
            if image == landscape1 || image == paint1 || image == color1 || image == shape1
            {
                SmellViewController.userTwoResponses.append("A")
            }
            else if image == landscape2 || image == paint2 || image == color2 || image == shape2
            {
                SmellViewController.userTwoResponses.append("B")
            }
            else if image == landscape3 || image == paint3 || image == color3 || image == shape3
            {
                SmellViewController.userTwoResponses.append("C")
            }
            else if image == landscape4 || image == paint4 || image == color4 || image == shape4
            {
                SmellViewController.userTwoResponses.append("D")
            }
            else if image == landscape5 || image == paint5 || image == color5 || image == shape5
            {
                SmellViewController.userTwoResponses.append("E")
            }
        }
        
        if SmellViewController.placementArray.count == 0
        {
            DispatchQueue.main.async {
                sender.setTitle("1", for: .normal)
                SmellViewController.placementArray.append("1")
            }
        }
        else if SmellViewController.placementArray.contains("1")
        {
            if SmellViewController.placementArray.contains("2")
            {
                if SmellViewController.placementArray.contains("3")
                {
                    if SmellViewController.placementArray.contains("4")
                    {
                        if SmellViewController.placementArray.contains("5")
                        {
                        ...
                        else
                        {
                            ...
                            SmellViewController.placementArray.append("5")
                        }
                    }
                    else
                    {
                        ...
                        SmellViewController.placementArray.append("4")
                    }
                }
                else
                {
                    ...
                    SmellViewController.placementArray.append("3")
                }
            }
            else
            {
                ...
                SmellViewController.placementArray.append("2")
            }
    ...
    func getPoints() -> Int
    {
        ...
        let user1GroupA = SmellViewController.userOneRespones[0...4]
        let user1GroupB = SmellViewController.userOneRespones[5...9]
        let user1GroupC = SmellViewController.userOneRespones[10...14]
        let user1GroupD = SmellViewController.userOneRespones[15...19]
        
        let user2GroupA = SmellViewController.userTwoResponses[0...4]
        let user2GroupB = SmellViewController.userTwoResponses[5...9]
        let user2GroupC = SmellViewController.userTwoResponses[10...14]
        let user2GroupD = SmellViewController.userTwoResponses[15...19]
